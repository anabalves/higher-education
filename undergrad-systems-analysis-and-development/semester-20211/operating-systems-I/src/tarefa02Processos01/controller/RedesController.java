	...
	public String getPing(String sistemaOperacional) {
		...
		if (sistemaOperacional.contains("Windows")) {
			try {
				...
				JOptionPane.showMessageDialog(null, "Processamento das informações...", "Info", JOptionPane.INFORMATION_MESSAGE);

				JOptionPane.showMessageDialog(null, "Realizando iterações do ping para www.google.com.br", "Info", JOptionPane.INFORMATION_MESSAGE);
				...
				return String.format("O Tempo médio das iterações solicitadas do endereço para ping www.google.com.br foi de:  %.2fms%n", media);
